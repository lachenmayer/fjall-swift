...
public final class WriteBatch: Sendable {
    ...
    @discardableResult
    public func durability(_ mode: PersistMode?) throws -> WriteBatch {
...
extension WriteBatch {
    ...
    public func insert(_ key: String, _ value: String, into keyspace: Keyspace) throws {
        try insert(Data(key.utf8), Data(value.utf8), into: keyspace)
    }

    /// Stages an insert of a value for a UTF-8 string key.
    public func insert(_ key: String, _ value: Data, into keyspace: Keyspace) throws {
        try insert(Data(key.utf8), value, into: keyspace)
    }

    /// Stages a removal of a UTF-8 string key.
    public func remove(_ key: String, from keyspace: Keyspace) throws {
